...
#define RS485_DRIVER_ENABLE()				(GPIO_D.port |=  _BV(RS485_DE_RE_PIN))
#define RS485_RECEIVER_ENABLE()				(GPIO_D.port &= ~_BV(RS485_DE_RE_PIN))
...
typedef struct rs485_buff_t {
	volatile rs485_data_ptr buff;
...
extern void rs485_init(struct rs485_cfg_t *cfg);
extern void rs485_ISR_reader(void);
extern void rs485_ISR_writer(void);
extern void rs485_read(rs485_data_ptr data, uint8_t size);
extern void rs485_write(rs485_data_ptr data, uint8_t size);
extern RS485_STAT_t rs485_receive_d(struct rs485_data_t* rx_d);
extern RS485_STAT_t rs485_send_d(uint8_t slave_addr_idx, struct rs485_data_t* tx_d);
extern void rs485_default_mode(void);
extern void rs485_switch_mode(RS485_CFG_MODE_t mode);
extern void rs485_send_proto(uint8_t slave_addr_idx, uint8_t proto_d);
